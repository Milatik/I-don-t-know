...
txt_next = 'Начать'
txt_instruction = 'Данное приложение позволит вам с помощью теста Руфье провести первиную диагостику вашего здоровья.\n'
               'Проба Руфье представляет собой нагрузочный комплекс, предназначенный для оценки роботоспособности сердца при физической нагрузке.\n'
...
txt_test3 = 'Лягте на спину и замерьте пульс сначала за первые 15 секунд минуты, затем за последние 15 секунд.n\ нажмите кнопу "Начать финальный тест". чтобы запустить таймер.\n Зеленын обозначены секунды, в течении в соответствующие поля.'
